...
<Image src="https://blob-cdn.documentation.ai/org-32657b98-c10c-411d-8b88-f43a8010b-8107-3714d598a727/1768826438987-z41uc1dht-pasted-image-1768826437250.png?q=85&fm=auto&auto=compress%2Cformat" width="3826" height="2160" alt="AI Search 2.0 results view with synthesized answer and Top 20 references" caption="AI Search 2.0 results view with synthesized answer and Top 20 references" />
...
## Export references from AI Search 2.0

Export the references from your AI Search 2.0 results to work in your reference manager, analysis tools, or spreadsheets.
...
Switch to a table-based view of your AI Search 2.0 results when you want to compare papers side by side or extract structured data.

<Steps>

<Step title="Open table view">

From the AI Search 2.0 results, click **Analyze in table view**. This opens the **Literature Review** table view with your current Top 20 references loaded.

</Step>

<Step title="Review and extract key details">
...
<Step title="Extend your reading set">
...
Save the references table from AI Search 2.0 into a workbook in your notebooks so you can keep analyzing, return later, and build on the same set of papers.
