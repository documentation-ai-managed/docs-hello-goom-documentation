...
<Columns cols="3">
  <Card title="Highlight Key Points" href="#annotation-tools" icon="highlighter" cta="See Highlighting" horizontal="false">
    Visually mark important sentences or figures directly within the PDF, making it easy to revisit key information later.
  </Card>

  <Card title="Add Comments" href="#annotation-tools" icon="message-square" cta="See Comments" horizontal="false">
    Attach context-rich comments to sections, helping you summarize, question, or connect ideas as you read.
  </Card>

  <Card title="Organize by Tag or Folder" href="#organizing-notes" icon="folder" cta="See Organization" horizontal="false">
...
<Steps>
  ...
  <Step title="Highlight & Annotate" icon="highlighter" title-type="p">
    Select important passages and apply highlights. Add comments to elaborate or question findings as you go.
  </Step>

  <Step title="Organize by Tags & Folders" icon="tag" title-type="p">
  ...
  <Step title="Revisit and Synthesize" icon="refresh-ccw" title-type="p">
