...
<h2 id="annotation-tools">Annotation Tools Overview</h2>
...
<Expandable title="How do I review all my highlights in a paper?" defaultOpen={false}>
...
<Expandable title="Can I export my annotations for use in other tools?" defaultOpen={false}>
