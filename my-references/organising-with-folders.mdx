...
<Steps>
  ...
  <Step title="Enter a name and save your folder" icon="check-circle" title-type="h3">
    Type your desired folder name in the input field that appears. Once entered, click the <kbd>Save</kbd> or <kbd>Create</kbd> button to add the folder to your library.
  </Step>
</Steps>
...
<Columns cols="2">
  ...
  <Card title="Manual Entry" href="/adding-references" icon="file-plus" cta="Add individually" horizontal="false">
